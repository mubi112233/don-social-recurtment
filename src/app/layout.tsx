...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "SocialRecruit — Social Media Recruitment Agency" }],
  },
  twitter: {
...
const serviceJsonLd = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: { "@type": "Service", name: "LinkedIn Recruiting", description: "Professional LinkedIn candidate sourcing and ABM campaigns" },
      },
      {
        "@type": "Offer",
        itemOffered: { "@type": "Service", name: "Meta Recruiting", description: "Facebook and Instagram recruitment campaigns with UGC" },
      },
      {
        "@type": "Offer",
        itemOffered: { "@type": "Service", name: "TikTok Recruitment", description: "Gen Z and Millennial talent acquisition through TikTok" },
      },
      {
        "@type": "Offer",
        itemOffered: { "@type": "Service", name: "Employer Branding", description: "Strategic employer brand content and positioning" },
      },
      {
        "@type": "Offer",
        itemOffered: { "@type": "Service", name: "Candidate Screening", description: "Pre-screening and skills assessment of applicants" },
      },
    ],
  },
};
