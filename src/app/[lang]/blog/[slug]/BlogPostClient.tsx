    ...
    <div className={`min-h-screen ${SPACING.sideMargin} bg-background`}>
      ...
      >
        ...
        <motion.div
          ...
          className="prose prose-base sm:prose-lg max-w-none mb-10 sm:mb-14 prose-headings:font-bold prose-p:text-foreground/90 prose-p:leading-relaxed prose-p:mb-5 prose-strong:text-blue-500 prose-h2:text-blue-500 prose-h3:text-blue-500"
